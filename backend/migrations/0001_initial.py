            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Обязательно: 150 значений или меньше. Только буквы, цифры и спецсимволы: @/./+/-/_",
                        max_length=150,
                        validators=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Указывает на то, что пользователь активныйСнимите флажок, чтобы сделать пользователя неактивным.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Время генерации токена"
                    ),
                ),
                (
                    "key",
                    ...
                    models.FloatField(
                        validators=[
                            django.core.validators.MinValueValidator(
                                0.1, message="Цена должна быть больше 0.1"
                            )
                        ],
                        verbose_name="Цена",
                    ),
                ...
                (
                    ...
                    models.FloatField(
                        validators=[
                            django.core.validators.MinValueValidator(
                                0.1,
                                message="Рекомендуемая розничная цена должна быть больше 0.1",
                            )
                        ],
